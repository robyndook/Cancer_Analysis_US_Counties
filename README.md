...
- *How you collected (or will collect) the data you like*
    ...
    - Webscraping Medically underserved area value/ median income/ Rural/Non-Rural/MUA index level for [Health Resources and Services Administration](https://data.hrsa.gov/tools/shortage-area/mua-find)
